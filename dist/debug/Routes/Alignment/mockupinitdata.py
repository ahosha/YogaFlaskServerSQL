...
def init_fine_alignment():
    ...
    JSON_FINE_ALIGMENT["data"]["frequency"] = 0
    JSON_FINE_ALIGMENT["data"]["currentCbw"] = 0
    JSON_FINE_ALIGMENT["data"]["SectorId"] = ""
...
# JSON_MEASURING return object for the measuring
...
def init_initial_data_hash():
    ...
    JSON_INIT_DATA_HASH["data"]["apiVersion"] = app.config['API_VERSION']
    JSON_INIT_DATA_HASH["data"]["hsuId"] = 7
    JSON_INIT_DATA_HASH["data"]["hsuLinkState"] = resource.unregistered
    JSON_INIT_DATA_HASH["data"]["hsuAirState"] = resource.air_state_transceiving
    ...
    JSON_INIT_DATA_HASH["data"]["aggregateCapacity"] = 1
    JSON_INIT_DATA_HASH["data"]["attachedAntennaIndication"] = 1
    JSON_INIT_DATA_HASH["data"]["hsuAirState"] = 1
...
def init_evaluation_results():
    ...
    JSON_EVALUATION_RESULTS['data']["CurrentRateIdx"] = 1
    JSON_EVALUATION_RESULTS['data']["hbsModulationRate"] = 1
