...
def getLinkData(req):
    result = {}
    result['hsuLinkState'] = "Not Synchronized"
    result['hsuAirState'] = "Alignment Required"
    result['currentCbw'] = "20"
    result['frequency'] = '5780'
    result['currentBand'] = "5.730-5.845 GHz FCC/IC"
    result['currentBandId'] = "5KDR/F58/SU/25/FCC/INT"
    result['antennaConnectionType'] = "Integrated"
    result['sectorType'] = 'Gen3'
    result['bandName'] = 'TestBandName'
...
def getFineAligmentMockup():
    ...
    JSON_FINE_ALIGMENT["data"]["currentCbw"] = "20"
    JSON_FINE_ALIGMENT["data"]["frequency"] = "5820"
    JSON_FINE_ALIGMENT["data"]["SectorId"] = "TestSectorId"
