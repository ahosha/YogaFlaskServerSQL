...
class SoftwareUpgrade(Resource):
     @jwt_required()
     def get(self, op_name):
         name = op_name
         if name == 'validate':
            return swu_validate_route(request)
         if name == 'backup':
            return swu_start_backup(request)
         if name == 'check-file-existence':
            return swu_check_file_existence(request)

     @jwt_required()
     def post(self, op_name):
         name = op_name
         if name == 'upload':
            return swu_upload_route(request)
         if name == 'start':
            return swu_start_route(request)
